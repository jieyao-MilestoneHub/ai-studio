...
add **~128 GB** 📏 (moondream3 47.6 + Qwen3-Omni-Captioner 63.4 + Tarsier2
16.6, read off each repo's file list on 2026-08-27, whole repos kept
complete — the loaders only open one checkpoint format each, but the
