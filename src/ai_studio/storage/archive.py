...
4. prune -- hot logs older than `log_hot_days` **only if a manifest names
...
still prunes. Never deletes a file it cannot prove is inside a verified
archive. Restore: `tar -I zstd -xf <tar> -C <dir>`.
